...
Now we just join the inflation data onto our income data by year, and colour by inflation-adjusted income using the same code for graphing as above.
...
We also grab the inflation adjustment factor for 2006 to 2021. With that we can simply plot the data, mapping the inflation-adjusted percent change 2006 to 2021.
