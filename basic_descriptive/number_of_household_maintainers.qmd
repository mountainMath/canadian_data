...
For the [2011 NHS](https://www23.statcan.gc.ca/imdb/p3Instr.pl?Function=assembleInstr&Item_Id=114641&lang=en&db=imdb&adm=8&dis=2) and [2016 census](https://www12.statcan.gc.ca/nhs-enm/2016/ref/questionnaires/questions-eng.cfm) the information on the number of household maintainers comes from the first question on the dwelling section, Question E1 and F1, respectively.
