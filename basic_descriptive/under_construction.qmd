...
The sharp increase in construction time for Semi-detached and row houses might well be a data anomaly, where dropping number of starts of such units can be disproportionally impacted by a couple of stalled projects.
