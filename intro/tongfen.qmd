---
title: "Introduction to the **tongfen** pacakge"
editor: visual
---

![](images/tongfen-sticker.png){#tongfen-logo style="float:right;margin-left:3em;" width="250"}

The [tongfen](https://mountainmath.github.io/tongfen/index.html) R package facilitates making data on different geometries comparable.
